...
export const INITIAL_PORTFOLIO: Portfolio[] = [
  {
    id: 'port-1',
    title: 'CJ대한통운 오네본부 E2 권역 풀필먼트 도급 운영',
    client: 'CJ대한통운',
    category: '물류도급',
    date: '2023-07-01',
    description: 'CJ대한통운 오네(O-NE) 본부 E2 권역의 풀필먼트 및 허브 분류 도급 전 과정을 총괄 운영합니다. 숙련된 인적 자원과 효율적인 공정 분담을 통해 실시간 입출고 정확도 99.9%를 달성하고 고효율 현장 제어를 정착시켰습니다.',
    imageUrl: port1Img,
    highlights: ['실시간 입출고 정확도 99.9%', 'O-NE 오퍼레이션 완벽 매칭', '분류 가공 리드타임 단축', '현장 오차율 ZERO화 실현']
  },
  {
    id: 'port-2',
    title: 'CJ대한통운 오네본부 D권역 도급 운영',
    client: 'CJ대한통운',
    category: '창고 관리',
    date: '2026-03-31',
  ...
  {
    id: 'port-3',
    title: 'CJ대한통운 서부집배점 라스트마일 인력 도급',
    client: 'CJ대한통운 서부집배점',
    category: '인력 아웃소싱',
    date: '2026-01-01',
    description: '서부집배점의 배송 및 라스트마일 허브 오퍼레이터 전문 인력 도급 및 순환 관리를 책임 운영합니다. 현장 대체 인력의 신속한 조달 시스템을 통해 결원율 0%를 기록하며 일일 배송 출발 마감 타임을 완벽 준수하고 있습니다.',
    imageUrl: port3Img,
